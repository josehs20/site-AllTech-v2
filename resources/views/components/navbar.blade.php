<header class="home-background" style="height: fit-content">
      <div class="d-flex justify-content-center" style="background-color: #fff; border: 1px solid; border-color: #ED750A">
          <ul class="nav">
              ...
              <li class="nav-item">
                  <a class="nav-link-icon" href="https://www.instagram.com/sistemas_alltech/"><span class="mai-logo-instagram"></span></a>
              </li>
          </ul>
      </div>
      ...
      <nav class="container-fluid navbar navbar-expand-lg navbar-transparent">
        ...
        <a href="{{ route('home') }}">  <img src="{{ url('/assets/img/logo.png') }}"  style="border-radius: 10px"  ></a>
              ...
              <div class="navbar-collapse collapse mx-auto" id="navbarContent">
                  <ul class="navbar navbar-nav ml-auto mx-auto">
                      ...
                      <li class="nav-item">
                          <a class="nav-link-whatsapp" href="https://api.whatsapp.com/send?phone=5522999238245&text=Olá, gostaria de mais informações.">Fale conosco <i class="mai-logo-whatsapp"></i></a>
                      </li>
                  </ul>

                  <div class="navbar navbar-nav">
                      <a class="btn btn-custom ml-lg-2" href="https://app.alltechsistemas.com.br/login">ÁREA DO CLIENTE</a>
                  </div>
              </div>
          </div>
      </nav>
