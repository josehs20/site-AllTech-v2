...
<body>
    ...
    <div class="page-section">
        <div class="container">
            <p class="titulopage">Downloads</p>
            <div class="row">
                <div class="col-lg-4">
                    <div class="card-service wow fadeInUp">
                        <div class="header">
                            <img src="../assets/img/teamviewer.png" alt="Logo ilustrando software team viewer">
                        </div>
                        <div class="body">
                        <p>Team Viewer</p>
                            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card-service wow fadeInUp">
                        <div class="header">
                            <img src="../assets/img/anydesk.png" alt="Logo ilustrando software anydesk">
                        </div>
                        <div class="body">
                        <p>AnyDesk</p>
                            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card-service wow fadeInUp">
                        <div class="header">
                            <img src="../assets/img/ammyyadmin.png" alt="">
                        </div>
                        <div class="body">
                            <p>Ammyy Admin</p>
                            <div class="row">
